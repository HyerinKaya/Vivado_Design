...
HD_PWD='C:/Users/admin/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log JK_FLIP_FLOP_BD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source JK_FLIP_FLOP_BD.tcl -notrace
