...
HD_PWD='C:/Users/admin/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JK_FLIP_FLOP_BD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source JK_FLIP_FLOP_BD.tcl
