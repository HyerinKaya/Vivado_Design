...
HD_PWD='C:/Users/admin/Downloads/project_7/project_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_BCD_counter_2bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_BCD_counter_2bit.tcl -notrace
