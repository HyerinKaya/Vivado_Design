...
HD_PWD='C:/Users/admin/Downloads/project_7/project_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_BCD_counter_2bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_BCD_counter_2bit.tcl
